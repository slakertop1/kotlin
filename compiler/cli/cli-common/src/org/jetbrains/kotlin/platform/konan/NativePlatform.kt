...
object NativePlatforms {
    ...
    fun nativePlatformByTargets(targets: Collection<KonanTarget>): TargetPlatform {
        ...
        return when (simplePlatforms.size) {
            ...
            1 -> nativePlatformBySingleTarget(simplePlatforms.single().target)
...
fun TargetPlatform?.isNative(): Boolean = if (this == null || isEmpty()) false else all { it is NativePlatform }
